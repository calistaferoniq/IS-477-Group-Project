...
# helper functions (from scripts/util_hash.py)
try:
...
SRC = Path("ai_job_dataset.csv")                     # this file already exists at repo root
DST = Path("data/raw/ai_job_dataset.csv")
DST.parent.mkdir(parents=True, exist_ok=True)

if not SRC.exists():
    raise SystemExit("ai_job_dataset.csv not found at repo root.")
copy2(SRC, DST)

write_sha256(str(DST))
write_acquisition_log(str(DST),
    "kaggle:bismasajjad/global-ai-job-market-and-salary-trends-2025",
